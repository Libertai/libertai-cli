...
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "login" -d 'Log in (browser sign-in or paste an API key)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "logout" -d 'Clear saved credentials (secrets removed; other settings kept)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "status" -d 'Show current auth state and defaults'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "keys" -d 'Manage API keys'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "models" -d 'List available models'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "ask" -d 'One-shot prompt, non-streaming'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "chat" -d 'Streaming chat REPL (Ctrl-D to exit)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "search" -d 'Web search via LibertAI\'s search API (search.libertai.io)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "fetch" -d 'Fetch a URL and return cleaned article text via search.libertai.io'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "image" -d 'Generate an image'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "run" -d 'Launch an arbitrary command with LibertAI env vars injected'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "claude" -d 'Launch Claude Code against LibertAI'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "opencode" -d 'Launch OpenCode against LibertAI'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "aider" -d 'Launch Aider against LibertAI'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "claw" -d 'Launch Claw Code (ultraworkers/claw-code) against LibertAI'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "hermes" -d 'Launch Hermes Agent against LibertAI'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "code" -d 'LibertAI\'s own coding agent, powered by pi_agent_rust'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "mcp" -d 'Run an MCP server exposing LibertAI web search and page fetch over stdio'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "config" -d 'Config file operations'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "skills" -d 'Install/list/uninstall the bundled agent skills (image gen etc)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "sandbox" -d 'Inspect the bash-sandbox configuration'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "import" -d 'Import data from other coding agents into a LibertAI session'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "completions" -d 'Print a shell completion script to stdout.'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "man" -d 'Render the top-level man page (roff) to stdout'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills sandbox import completions man help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
