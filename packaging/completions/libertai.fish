...
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove help" -s h -l help -d 'Print help'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove help" -s V -l version -d 'Print version'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove help" -f -a "list" -d 'List installed plugins and their enabled/trusted state'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove help" -f -a "marketplace" -d 'Manage plugin marketplaces'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove help" -f -a "install" -d 'Install a plugin from an added marketplace (`name` or `name@marketplace`)'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove help" -f -a "audit" -d 'Audit a plugin (capabilities + scan) without installing it'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove help" -f -a "enable" -d 'Enable an installed plugin\'s components'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove help" -f -a "disable" -d 'Disable an installed plugin\'s components'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove help" -f -a "remove" -d 'Uninstall a plugin and delete its files'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
