...
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code agents mcp config skills sandbox import completions man help" -f -a "keys" -d 'Manage API keys'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code agents mcp config skills sandbox import completions man help" -f -a "models" -d 'List available models'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code agents mcp config skills sandbox import completions man help" -f -a "ask" -d 'One-shot prompt, non-streaming'
...
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code agents mcp config skills sandbox import completions man help" -f -a "image" -d 'Generate an image'
...
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status keys models ask chat search fetch image run claude opencode aider claw hermes code agents mcp config skills sandbox import completions man help" -f -a "config" -d 'Config file operations'
