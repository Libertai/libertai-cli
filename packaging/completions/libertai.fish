...
complete -c libertai -n "__fish_libertai_needs_command" -f -a "code" -d 'LibertAI\'s own coding agent, powered by alforria'
complete -c libertai -n "__fish_libertai_needs_command" -f -a "mcp" -d 'One screen for all your coding-agent sessions'
...
complete -c libertai -n "__fish_libertai_using_subcommand code" -l sandbox -d 'Accepted for backwards compatibility; the alforria engine has no sandbox mode, so this only prints a warning'
...
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "login" -d 'Log in (browser sign-in or paste an API key)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "logout" -d 'Clear saved credentials (secrets removed; other settings kept)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "status" -d 'Show current auth state and defaults'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "usage" -d 'Show plan tier, allowance windows (5h + weekly), and prepaid credits'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "keys" -d 'Manage API keys'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "models" -d 'List available models'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "ask" -d 'One-shot prompt, non-streaming'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "chat" -d 'Streaming chat REPL (Ctrl-D to exit)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "search" -d 'Web search via LibertAI\'s search API (search.libertai.io)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "fetch" -d 'Fetch a URL and return cleaned article text via search.libertai.io'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "image" -d 'Generate an image'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "run" -d 'Launch an arbitrary command with LibertAI env vars injected'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "claude" -d 'Launch Claude Code against LibertAI'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "opencode" -d 'Launch OpenCode against LibertAI'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "aider" -d 'Launch Aider against LibertAI'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "claw" -d 'Launch Claw Code (ultraworkers/claw-code) against LibertAI'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "hermes" -d 'Launch Hermes Agent against LibertAI'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "code" -d 'LibertAI\'s own coding agent, powered by alforria'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "mcp" -d 'One screen for all your coding-agent sessions'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "config" -d 'Config file operations'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "skills" -d 'Install/list/uninstall the bundled agent skills (image gen etc)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "completions" -d 'Print a shell completion script to stdout.'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "man" -d 'Render the top-level man page (roff) to stdout'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys models ask chat search fetch image run claude opencode aider claw hermes code mcp config skills completions man help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
