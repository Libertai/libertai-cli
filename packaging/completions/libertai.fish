...
complete -c libertai -n "__fish_libertai_needs_command" -f -a "plugin" -d 'Manage plugins and marketplaces (Claude-Code compatible)'
...
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove sign help" -s h -l help -d 'Print help'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove sign help" -s V -l version -d 'Print version'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove sign help" -f -a "list" -d 'List installed plugins and their enabled/trusted state'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove sign help" -f -a "marketplace" -d 'Manage plugin marketplaces'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove sign help" -f -a "install" -d 'Install a plugin from an added marketplace (`name` or `name@marketplace`)'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove sign help" -f -a "audit" -d 'Audit a plugin (capabilities + scan) without installing it'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove sign help" -f -a "enable" -d 'Enable an installed plugin\'s components'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove sign help" -f -a "disable" -d 'Disable an installed plugin\'s components'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove sign help" -f -a "remove" -d 'Uninstall a plugin and delete its files'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove sign help" -f -a "sign" -d 'Sign a plugin directory in place (writes .libertai-plugin/signature.json)'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and not __fish_seen_subcommand_from list marketplace install audit enable disable remove sign help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from list" -s V -l version -d 'Print version'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from marketplace" -s h -l help -d 'Print help'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from marketplace" -s V -l version -d 'Print version'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from marketplace" -f -a "add" -d 'Add a marketplace from a git URL or local path'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from marketplace" -f -a "list" -d 'List added marketplaces'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from marketplace" -f -a "remove" -d 'Remove an added marketplace'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from marketplace" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from install" -l scan -d 'Force the external security scan before installing'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from install" -l no-scan -d 'Skip the external security scan'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from install" -l trust -d 'Trust the plugin\'s hooks/MCP servers to run (no prompt)'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from install" -s y -l yes -d 'Assume yes to prompts (non-interactive; never auto-trusts code)'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from install" -s h -l help -d 'Print help'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from install" -s V -l version -d 'Print version'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from audit" -s h -l help -d 'Print help'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from audit" -s V -l version -d 'Print version'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from enable" -s h -l help -d 'Print help'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from enable" -s V -l version -d 'Print version'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from disable" -s h -l help -d 'Print help'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from disable" -s V -l version -d 'Print version'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from remove" -s h -l help -d 'Print help'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from remove" -s V -l version -d 'Print version'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from sign" -l key -d 'Signing key hex (with or without 0x); else $LIBERTAI_SIGNING_KEY' -r
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from sign" -s h -l help -d 'Print help'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from sign" -s V -l version -d 'Print version'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "list" -d 'List installed plugins and their enabled/trusted state'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "marketplace" -d 'Manage plugin marketplaces'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "install" -d 'Install a plugin from an added marketplace (`name` or `name@marketplace`)'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "audit" -d 'Audit a plugin (capabilities + scan) without installing it'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "enable" -d 'Enable an installed plugin\'s components'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "disable" -d 'Disable an installed plugin\'s components'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "remove" -d 'Uninstall a plugin and delete its files'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "sign" -d 'Sign a plugin directory in place (writes .libertai-plugin/signature.json)'
complete -c libertai -n "__fish_libertai_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c libertai -n "__fish_libertai_using_subcommand code" -l acp -d 'Speak the Agent Client Protocol (ACP) on stdin/stdout instead of starting a terminal session, so an editor can drive the agent. ACP is Zed\'s editor↔agent standard (also supported by the JetBrains IDEs); it is line-delimited JSON-RPC 2.0, so stdout carries protocol frames and nothing else — logs and warnings go to stderr. Refuses to start under `--sandbox` (or `LIBERTAI_SANDBOX`): the protocol server builds its own tools and cannot wrap bash. Not for interactive use: point your editor at `libertai code --acp`. See the README for Zed and JetBrains setup'
...
complete -c libertai -n "__fish_libertai_using_subcommand skills; and not __fish_seen_subcommand_from list install uninstall help" -f -a "uninstall" -d 'Remove the bundled skills installed by this CLI, from both Claude Code\'s and OpenCode\'s skill dirs'
...
complete -c libertai -n "__fish_libertai_using_subcommand skills; and __fish_seen_subcommand_from help" -f -a "uninstall" -d 'Remove the bundled skills installed by this CLI, from both Claude Code\'s and OpenCode\'s skill dirs'
...
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys plugin models ask chat search fetch image run claude opencode aider claw hermes code agents mcp config skills sandbox import completions man help" -f -a "login" -d 'Log in (browser sign-in or paste an API key)'
...
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys plugin models ask chat search fetch image run claude opencode aider claw hermes code agents mcp config skills sandbox import completions man help" -f -a "keys" -d 'Manage API keys'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys plugin models ask chat search fetch image run claude opencode aider claw hermes code agents mcp config skills sandbox import completions man help" -f -a "plugin" -d 'Manage plugins and marketplaces (Claude-Code compatible)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys plugin models ask chat search fetch image run claude opencode aider claw hermes code agents mcp config skills sandbox import completions man help" -f -a "models" -d 'List available models'
...
complete -c libertai -n "__fish_libertai_using_subcommand help; and not __fish_seen_subcommand_from login logout status usage keys plugin models ask chat search fetch image run claude opencode aider claw hermes code agents mcp config skills sandbox import completions man help" -f -a "image" -d 'Generate an image'
...
complete -c libertai -n "__fish_libertai_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "list" -d 'List installed plugins and their enabled/trusted state'
complete -c libertai -n "__fish_libertai_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "marketplace" -d 'Manage plugin marketplaces'
complete -c libertai -n "__fish_libertai_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "install" -d 'Install a plugin from an added marketplace (`name` or `name@marketplace`)'
complete -c libertai -n "__fish_libertai_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "audit" -d 'Audit a plugin (capabilities + scan) without installing it'
complete -c libertai -n "__fish_libertai_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "enable" -d 'Enable an installed plugin\'s components'
complete -c libertai -n "__fish_libertai_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "disable" -d 'Disable an installed plugin\'s components'
complete -c libertai -n "__fish_libertai_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "remove" -d 'Uninstall a plugin and delete its files'
complete -c libertai -n "__fish_libertai_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "sign" -d 'Sign a plugin directory in place (writes .libertai-plugin/signature.json)'
...
complete -c libertai -n "__fish_libertai_using_subcommand help; and __fish_seen_subcommand_from skills" -f -a "uninstall" -d 'Remove the bundled skills installed by this CLI, from both Claude Code\'s and OpenCode\'s skill dirs'
